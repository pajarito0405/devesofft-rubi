...
(function (t) {
                ...
                "mousemove.smartmenus_mouse": function (s) {
                    ...
                    if (o) {
                        ...
                        if ((r > 0 || h > 0) && 2 >= r && 2 >= h && 300 >= a.timeStamp - o.timeStamp && (n = !0, e)) {
                            var u = t(s.target);
                            u.is("a") || (u = u.parentsUntil("a").parent()), u.is("a") && t.each(i, function () {
    ...
    t.SmartMenus = function (s, i) {
        this.$root = t(s), this.opts = i, this.$subArrow = null, this.subMenus = [], this.activatedItems = [], this.visibleSubMenus = [], this.showTimeout = 0, this.hideTimeout = 0, this.scrollTimeout = 0, this.clickActivated = !1, this.zIndexInc = 0, this.$firstLink = null, this.$firstSub = null, this.disabled = !1, this.$disableOverlay = null, this.init()
        ...
        hideAll: function () {
            ...
            init: function (e) {
                var o = this;
                if (!e) {
                    i.push(this), this.$root.hasClass("sm-rtl") && (this.opts.rightToLeftSubMenus = !0), this.$root.data("smartmenus", this).dataSM("level", 1).bind({
                    ...
                    var a = ".smartmenus" + this.$root[0].id;
                ...
                if (this.$firstSub = this.$root.find("ul").each(function () {
                        o.menuInit(t(this))
                    }).eq(0), this.$firstLink = this.$root.find("a:first"), this.opts.markCurrentItem) {
                ...
                this.menuHideAll(), this.$root.removeData("smartmenus").removeDataSM("level").unbind(".smartmenus").undelegate(".smartmenus");
                var s = ".smartmenus" + this.$root[0].id;
                ...
                (this.visibleSubMenus[0] && !t.contains(this.$root[0], s.target) || t(s.target).is("a")) && this.menuHideAll()
            }, docTouchEnd: function () {
                if (this.lastTouch) {
                    if (!(!this.visibleSubMenus[0] || void 0 !== this.lastTouch.x2 && this.lastTouch.x1 != this.lastTouch.x2 || void 0 !== this.lastTouch.y2 && this.lastTouch.y1 != this.lastTouch.y2 || this.lastTouch.target && t.contains(this.$root[0], this.lastTouch.target))) {
                ...
                if (o > 1 && (!this.activatedItems[o - 2] || this.activatedItems[o - 2][0] != e.dataSM("parent-a")[0])) {
                    var a = this;
                    t(e.parentsUntil("#" + this.$root[0].id, "ul").get().reverse()).add(e).each(function () {
                ...
                if (!this.disabled && this.isCSSOn()) {
                    ...
                    i.parent().parent().dataSM("level") && this.$root.triggerHandler("blur.smapi", i[0])
                }
                ...
                if (!this.disabled && this.isCSSOn()) {
                    var i = t(s.currentTarget);
                    if (i.parent().parent().dataSM("level")) {
                        if (!this.isTouchMode()) {
                ...
                if (!this.disabled && this.isCSSOn()) {
                    var i = t(s.currentTarget);
                    i.parent().parent().dataSM("level") && (this.isTouchMode() && s.originalEvent || this.itemActivate(i), this.$root.triggerHandler("focus.smapi", i[0]))
                }
            }, itemLeave: function (s) {
                if (!this.disabled && this.isCSSOn()) {
                    var i = t(s.currentTarget);
                    i.parent().parent().dataSM("level") && (this.isTouchMode() || (i[0].blur && i[0].blur(), this.showTimeout && (clearTimeout(this.showTimeout), this.showTimeout = 0)), this.$root.triggerHandler("mouseleave.smapi", i[0]))
                }
            }, itemTouchEnd: function (s) {
                if (!this.disabled && this.isCSSOn()) {
                    var i = t(s.currentTarget), e = i.parent().dataSM("sub");
                ...
                if (w ? (i = this.opts.rightToLeftSubMenus ? m - h - g : g, e = this.opts.bottomToTopSubMenus ? -u - g : p + T) : (i = this.opts.rightToLeftSubMenus ? g - h : m - g, e = this.opts.bottomToTopSubMenus ? p - T - u : T), this.opts.keepInViewport && !this.isCollapsible()) {
                    ...
                    var $ = d + i, y = c + e;
                    if (this.opts.rightToLeftSubMenus && v > $ ? i = w ? v - $ + i : m - g : !this.opts.rightToLeftSubMenus && $ + h > v + S && (i = w ? v + S - h - $ + i : g - h), w || (M > u && y + u > b + M ? e += b + M - u - y : (u >= M || b > y) && (e += b - y)), n && (w && (y + u > b + M + .49 || b > y) || !w && u > M + .49)) {
                        var x = this;
                        s.dataSM("scroll-arrows") || s.dataSM("scroll-arrows", t([t('<span class="scroll-up"><span class="scroll-up-arrow"></span></span>')[0], t('<span class="scroll-down"><span class="scroll-down-arrow"></span></span>')[0]]).eq(0).hover(function () {
                            x.menuScroll(s, !0)
                        }, function (t) {
                            x.menuScrollStop(s), x.menuScrollOut(s, t)
                        }).bind("mousewheel DOMMouseScroll", function (t) {
                            t.preventDefault()
                        ...
                        }).eq(0).css("margin-top", I).end().eq(1).css("margin-top", I + M - this.getHeight(s.dataSM("scroll-arrows").eq(1))).end().eq(w && this.opts.bottomToTopSubMenus ? 0 : 1).show()
                    }
                }
                s.css({
                    top: "auto",
                ...
                if ((t.dataSM("beforefirstshowfired") || (t.dataSM("beforefirstshowfired", !0), this.$root.triggerHandler("beforefirstshow.smapi", t[0]) !== !1)) && this.$root.triggerHandler("beforeshow.smapi", t[0]) !== !1 && (this.menuFixLayout(t), t.stop(!0, !0), !t.is(":visible"))) {
                    ...
                    if (o ? t.parent().css("z-index", s) : t.css("z-index", s), (this.opts.keepHighlighted || this.isCollapsible()) && t.dataSM("parent-a").addClass("highlighted"), this.opts.subMenusMinWidth || this.opts.subMenusMaxWidth)if (a)if (r) {
                        if (t.width(this.opts.subMenusMinWidth ? this.opts.subMenusMinWidth : 1).children().css("styleFloat", "none").children("a").css("white-space", "nowrap"), this.opts.subMenusMaxWidth) {
                            var i = t.width(), e = t.css({
                        ...
                        if (t.children().css("styleFloat", "none"), t.css({
                                width: "auto",
                                minWidth: "",
                                maxWidth: ""
                            }).addClass("sm-nowrap"), this.opts.subMenusMinWidth && t.css("min-width", this.opts.subMenusMinWidth), this.opts.subMenusMaxWidth) {
                            var i = t.width();
                            t.css("max-width", this.opts.subMenusMaxWidth), i > t.width() ? t.removeClass("sm-nowrap").css("width", this.opts.subMenusMaxWidth) : t.width(i)
                        } else t.width(t.width());
                        t.children().css("styleFloat", "left")
                    } else if (t.css({
                            width: "auto",
                    ...
                    this.menuPosition(t), t.dataSM("ie-shim") && t.dataSM("ie-shim").insertBefore(t), this.isCollapsible() ? this.opts.collapsibleShowFunction ? this.opts.collapsibleShowFunction.call(this, t) : t.show(this.opts.collapsibleShowDuration) : this.opts.showFunction ? this.opts.showFunction.call(this, t) : t.show(this.opts.showDuration), this.visibleSubMenus[t.dataSM("level") - 1] = t, this.$root.triggerHandler("show.smapi", t[0])
                }
                ...
                if (!this.isTouchMode() && t.target != this.$root[0] && (this.hideTimeout && (clearTimeout(this.hideTimeout), this.hideTimeout = 0), !this.opts.showOnClick || !this.opts.hideOnClick)) {
                    var s = this;
                    this.hideTimeout = setTimeout(function () {
                        s.menuHideAll()
                ...
                this.isTouchMode() || t.target != this.$root[0] && this.hideTimeout && (clearTimeout(this.hideTimeout), this.hideTimeout = 0)
                ...
                } else this.isCollapsible() || "onorientationchange"in window && "orientationchange" != t.type || (this.activatedItems.length > 0 && this.activatedItems[this.activatedItems.length - 1][0].blur(), this.menuHideAll())
            }
        }
