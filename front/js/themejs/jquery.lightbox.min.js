...
(function (a) {
        ...
        constructor: o, init: function () {
            ...
            d.data && (c = a.extend(d.data, c)), z(f, [b, c, d]), a.each(c, function (a, c) {
                ...
                if (e.length > 1) {
                    ...
                    if (d.length > 0) {
                        var f = e[1];
                        f === "replaceWith" ? d[0] !== c[0] && d.replaceWith(c) : f === "img" ? d.is("img") ? d.attr("src", c) : d.replaceWith('<img alt="" src="' + c + '" class="' + d.attr("class") + '" />') : d.attr(e[1], c)
                    }
    ...
    a.magnificPopup.registerModule(K, {
        options: {
            ...
            initAjax: function () {
                n.types.push(K), L = n.st.ajax.cursor, x(b + "." + K + " BeforeChange." + K, function () {
                    M(), n.req && n.req.abort()
                })
            }, getAjax: function (b) {
    ...
    a.magnificPopup.registerModule("gallery", {
        options: {
            ...
            initGallery: function () {
                ...
                var c = n.items[b];
                c.parsed || (c = n.parseEl(b)), z("LazyLoad", c), c.type === "image" && (c.img = a('<img alt="" class="mfp-img" />').on("load.mfploader", function () {
                    c.hasSize = !0
