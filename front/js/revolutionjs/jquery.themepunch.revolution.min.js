...
(function (e, t) {
    ...
    function l(n, r) {
        ...
        n.find(">ul:first >li").each(function (e) {
            ...
            s.append('<div class="bullet thumb" style="width:' + r.thumbWidth + "px;height:" + r.thumbHeight + 'px;"><img alt="" src="' + o + '"></div>');
    ...
    function w(n, r) {
        ...
        n.find(">ul:first >li >img").each(function (n) {
            ...
            if (o(8)) {
                ...
                c.find(".tp-bgimg").append('<img alt="" class="ieeightfallbackimage defaultimg" src="' + s + '" style="width:100%">')
            }
            i.css({opacity: 0});
            i.data("li-id", n)
        })
    ...
    function E(e, n, r, i) {
        ...
        if (i == "horizontal") {
            ...
            for (var E = 0; E < n.slots; E++) {
                ...
                if (o(8)) {
                    s.find(".slot ").last().find(".slotslide").append('<img alt="" class="ieeightfallbackimage" src="' + w + '" style="width:100%">');
                    x(s, n)
                }
            }
        } else {
    ...
    function S(e, n, r) {
        ...
        for (var T = 0; T < n.slots; T++) {
            ...
            for (var N = 0; N < n.slots; N++) {
                ...
                y = y + m;
                if (o(8)) {
                    i.find(".slot ").last().find(".slotslide").append('<img alt="" src="' + v + '">');
                    x(i, n)
                }
