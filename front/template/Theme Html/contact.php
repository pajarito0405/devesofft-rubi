            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                        ...
                        <img alt="" class="img-rounded alignleft" src="img/theme/who-thumb.jpg">

                        <p><strong>Sliding Panel</strong> can be filled with any html content. The Boostrap Grid can be
                            used to create the necesary columns and rows. It supports any element provided in this theme
                            starting from typography elements, videos and images gallery and go all the way to complex
                            elements.</p>

                        <p class="lead margin-top20">We hope you enjoy it.</p>

                        <div class="btn-group">
                            <a class="btn btn-primary btn-border">Read More<i
                                    class="fa fa-share fa-margin-left"></i></a>
                            <a class="btn btn-default btn-border">Order SmartOn<i
                                    class="fa fa-shopping-cart fa-margin-left"></i></a>
                        </div>
                        <div class="blank-spacer padding-xsmall"></div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                            ...
                            <ul class="list-inline">
                                    ...
                                    <div class="top-cart">
                                        ...
                                        <div class="toggle-container">
                                            ...
                                            <div class="togglebox">
                                                ...
                                                <ul class="media-list">
                                                    <li class="media">
                                                        <a class="pull-right" href="#"><img alt="" class="media-object"
                                                                                            src="img/demo/thumbs/iphone-concept.jpg"
                                                                                            width="64" height="64"></a>

                                                        <div class="media-body">
                                                            <h4 class="media-heading title-color">iPhone 6s Concept</h4>
                                                            Quisque eleifend nulla euismod accumsan iaculis. Donec id
                                                            luctus lorem. Nullam pellentesque, ante quis.
                                                        </div>
                                                    </li>
                                                    <li class="media">
                                                        <a class="pull-right" href="#"><img alt="" class="media-object"
                                                                                            src="img/demo/thumbs/lords.jpg"
                                                                                            width="64" height="64"></a>

                                                        <div class="media-body">
                                                            <h4 class="media-heading title-color">Two Towers</h4>
                                                            Aliquam erat volutpat. Quisque hendrerit nibh ac ligula
                                                            imperdiet mattis. Praesent consectetur, sem tempor.
                                                        </div>
                                                    </li>
                                                </ul>
                                                <div class="clearfix"></div>
                                                <h4><strong>Subtotal:</strong>
                                                    <small>2 items, Total of $856</small>
                                                </h4>
                                                <div class="btn-group btn-group-sm">
                                                    <button type="button" class="btn btn-primary">View Cart <i
                                                            class="fa fa-angle-right fa-margin-left"></i></button>
                                                    <button type="button" class="btn btn-primary">Checkout <i
                                                            class="fa fa-angle-right fa-margin-left"></i></button>
                                                </div>
                                            </div>
                                ...
                                <li>
                                    <div class="top-login">
                                        ...
                                        <a href="#login" data-toggle="modal" class="toggle-link"><i
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal"
                                                                aria-hidden="true"><i class="fa fa-times-circle-o"></i>
                                                        </button>
                                                        <h3 class="modal-title title-color" id="myModalLabel"><i
                                                                class="fa fa-user"></i> User Login</h3>
                                                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="top-menu-right"><!-- Top Menu right -->
                            ...
                            <ul class="top-social list-inline">
                                <li><a class="tooltip-on" title="Facebook" href="http://www.facebook.com">
                                        <div class="icon-wrapper icon-border-round"><i class="fa fa-facebook"></i></div>
                                    </a></li>
                                <li><a class="tooltip-on" title="Twitter" href="http://www.twitter.com">
                                        <div class="icon-wrapper icon-border-round"><i class="fa fa-twitter"></i></div>
                                    </a></li>
                                <li><a class="tooltip-on" title="Google Plus" href="http://www.google.com">
                                        <div class="icon-wrapper icon-border-round"><i class="fa fa-google-plus"></i>
                                        </div>
                                    </a></li>
                                <li><a class="tooltip-on" title="Linkedin" href="http://www.twitter.com">
                                        <div class="icon-wrapper icon-border-round"><i class="fa fa-linkedin"></i></div>
                                    </a></li>
                                <li><a class="tooltip-on" title="Pinterest" href="http://www.twitter.com">
                                        <div class="icon-wrapper icon-border-round"><i class="fa fa-pinterest"></i>
                                        </div>
                                    </a></li>
                                <li><a class="tooltip-on" title="RSS" href="http://www.twitter.com">
                                        <div class="icon-wrapper icon-border-round"><i class="fa fa-rss"></i></div>
                                    </a></li>
                            </ul>
            ...
            <div class="container"> <!-- Container -->
                ...
                <div class="row"><!-- Row-->
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="logo">
                            <a href="index.html"><img src="img/theme/logo.png" width="185" height="54"
                                                      alt="SmartON Logo"></a>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="main-navigation">
                            ...
                            <ul id="main-menu" class="sm sm-default">
                                <li><a class="disabled has-submenu" href="index.html">Home</a>
                                    <ul>
                                ...
                                <li><a class="disabled has-submenu">Features</a>
                                    <ul>
                                        <li><a>Elements</a>
                                            <ul>
                                ...
                                <li><a class="disabled has-submenu">Styles</a>
                                    <ul>
                                        <li><a class="disabled has-submenu">Header Styles</a>
                                            <ul>
                                                ...
                                                <li><a href="header-top-dark-center.html">Centered Header (dark)</a>
                                                </li>
                                                <li><a href="header-top-light-center.html">Centered Header (light)</a>
                                                </li>
                                        ...
                                        <li><a class="disabled has-submenu">Footer Styles</a>
                                            <ul>
                                                ...
                                                <li><a href="footer-wide-small.html#footer-view">Small Footer Wide</a>
                                                </li>
                                                <li><a href="footer-boxed-small.html#footer-view">Small Footer Boxed</a>
                                                </li>
                                ...
                                <li><a class="disabled has-submenu">Pages</a>
                                    <ul>
                                    ...
                                    <ul>
                                        <li><a class="disabled has-submenu">Portoflio 1 Column</a>
                                            <ul>
                                                ...
                                                <li><a href="portfolio-1-cols-with-toggled-text.html">Items With Toggled
                                                        Text</a></li>
                                                <li><a href="portfolio-1-cols-without-text.html">Items Without Text</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a class="disabled has-submenu">Portfolio 2 Columns</a>
                                            <ul>
                                                ...
                                                <li><a href="portfolio-2-cols-with-toggled-text.html">Items With Toggled
                                                        Text</a></li>
                                                <li><a href="portfolio-2-cols-without-text.html">Items Without Text</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a class="disabled has-submenu">Portfolio 3 Columns</a>
                                            <ul>
                                                ...
                                                <li><a href="portfolio-3-cols-with-toggled-text.html">Items With Toggled
                                                        Text</a></li>
                                                <li><a href="portfolio-3-cols-without-text.html">Items Without Text</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a class="disabled has-submenu">Portfolio 4 Columns</a>
                                            <ul>
                                                ...
                                                <li><a href="portfolio-4-cols-with-toggled-text.html">Items With Toggled
                                                        Text</a></li>
                                                <li><a href="portfolio-4-cols-without-text.html">Items Without Text</a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li><a class="disabled has-submenu">Portfolio Mixed Columns</a>
                                            <ul>
                                                <li><a href="portfolio-mixed-cols-with-text.html">Items With Text</a>
                                                </li>
                                                <li><a href="portfolio-mixed-cols-with-toggled-text.html">Items With
                                                        Toggled Text</a></li>
                                                <li><a href="portfolio-mixed-cols-without-text.html">Items Without
                                                        Text</a></li>
                                            </ul>
                                        </li>
                                        <li><a class="disabled has-submenu">Portfolio Sidebar</a>
                                            <ul>
                                                <li><a href="portfolio-sidebar-left.html">Portfolio Sidebar Left</a>
                                                </li>
                                                <li><a href="portfolio-sidebar-right.html">Portfolio Sidebar Right</a>
                                                </li>
                                            </ul>
                                        </li>
                                            ...
                                            <ul>
                                                <li><a class="disabled has-submenu">Full Width</a>
                                                    <ul>
                                                        ...
                                                        <li><a href="portfolio-single-full-gallery.html">Gallery</a>
                                                        </li>
                                                ...
                                                <li><a class="disabled has-submenu">Split Half</a>
                                                    <ul>
                                                        ...
                                                        <li><a href="portfolio-single-split-gallery.html">Gallery</a>
                                                        </li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a class="disabled has-submenu">Blog Single Article</a>
                                            <ul>
                                                ...
                                                <li><a href="blog-single-nosidebar.html">Blog Single Article No
                                                        Sidebar</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                <li><a class="disabled has-submenu">Contact</a>
                                    <ul>
    ...
    <div class="fullsize">
        ...
        <div class="page-header">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h1 class="title-color page-title">Contact Us
                            <small> - using header</small>
                        </h1>
                    </div>
                    <div class="col-md-6">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><a class="disabled has-submenu" href="contact.html">Contact</a></li>
        ...
        <div class="container container-inner"> <!-- Container -->
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <h3 class="title-color">Send us a message!</h3>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" id="contactForm" role="form" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        <input type="Email" class="form-control input-lg" id="inputEmail"
                                               name="inputEmail" placeholder="Enter Your Email"/>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        <textarea class="form-control" rows="6" placeholder="Enter Your Message"
                                                  id="inputMessage" name="inputMessage"></textarea>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        <button type="submit" class="btn btn-primary" id="send" name="send">Contact Us
                                        </button>
                                    </div>
                                </div>
                            </form>
                ...
                <div class="col-md-6">
                    ...
                    <h3 class="title-color">Contact Info</h3>

                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <h4 class="box-icon-title margin-top20 margin-bottom20">
                                <span class="icon-wrapper icon-border-round color-default"><i
                                        class="fa fa-home"></i></span>Office Address
                            </h4>
                            <ul class="list-divider">
                                <li>001 Some Street. Los Angeles</li>
                                <li>CA, 12345. USA</li>
                            </ul>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <h4 class="box-icon-title margin-top20 margin-bottom20">
                                <span class="icon-wrapper icon-border-round color-default"><i
                                        class="fa fa-phone"></i></span>Office Phones
                            </h4>
                            <ul class="list-divider">
                                <li>(123) 456-7890</li>
                                <li>(123) 456-7890</li>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            ...
                            <ul class="list-divider">
                                <li>office@smarton.com</li>
                                <li>sales@smarton.com</li>
                            </ul>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <h4 class="box-icon-title margin-top20 margin-bottom20">
                                <span class="icon-wrapper icon-border-round color-default"><i class="fa fa-clock-o"></i></span>We
                                are open!
                            </h4>
                            <ul class="list-divider">
                                <li>Monday - Friday: <strong>09:00 - 18:00</strong></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="footer-widget">
                            ...
                            <p class="lead">"<em>Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor
                                    auctor.</em>"</p>

                            <p><strong>Integer rhoncus auctor eros at viverra.</strong> Donec ornare mi quis nulla
                                euismod volutpat. Nulla eget suscipit odio. <strong>Curabitur eleifend</strong> mi eget
                                tincidunt porta. Integer egestas, augue id luctus bibendum.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="footer-widget">
                            ...
                            <p>We say what we do, we do what we say, and we're looking forward to prove it to you.
                            </p>
                            <ul class="fa-ul">
                                <li><i class="fa-li fa fa-map-marker"></i>001 Some Street. Los Angeles, CA, 12345. USA
                                </li>
                                <li><i class="fa-li fa fa-print"></i>(123) 456-7890</li>
                                <li><i class="fa-li fa fa-phone"></i>(123) 456-7890</li>
                    ...
                    <div class="col-md-3">
                        <div class="footer-widget">
                            ...
                            <ul class="footer-custom-menu">
                                ...
                                <li><a href="#">Vestibulum tellus nulla, molestie et aliquet vel, vulputate eu orci.</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="fullsize container"> <!-- Container -->
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="footer-social list-inline">
                            <li><a href="http://www.facebook.com">
                                    <div class="icon-wrapper icon-border-round fa-2x"><i class="fa fa-facebook"></i>
                                    </div>
                                </a></li>
                            <li><a href="http://www.twitter.com">
                                    <div class="icon-wrapper icon-border-round fa-2x"><i class="fa fa-twitter"></i>
                                    </div>
                                </a></li>
                            <li><a href="https://plus.google.com/‎">
                                    <div class="icon-wrapper icon-border-round fa-2x"><i class="fa fa-google-plus"></i>
                                    </div>
                                </a></li>
                            <li><a href="https://www.linkedin.com/">
                                    <div class="icon-wrapper icon-border-round fa-2x"><i class="fa fa-linkedin"></i>
                                    </div>
                                </a></li>
                            <li><a href="http://www.pinterest.com/">
                                    <div class="icon-wrapper icon-border-round fa-2x"><i class="fa fa-pinterest"></i>
                                    </div>
                                </a></li>
                            <li><a href="#rss">
                                    <div class="icon-wrapper icon-border-round fa-2x"><i class="fa fa-rss"></i></div>
                                </a></li>
                        </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-pull-6">
                        <div class="copyright">© 2013 SmartOn Wordpress/Joomla/HTML Theme. All Rights Reserved.</div>
                    </div>
                </div>
