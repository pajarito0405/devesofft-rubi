...
jQuery(document).ready(function () {
    ...
    jQuery("#air2").niceScroll({
        horizrailenabled: false
    });
    jQuery("#hotel2").niceScroll({
        horizrailenabled: false
    });
    jQuery("#car2").niceScroll({
        horizrailenabled: false
    });
    jQuery("#vacations2").niceScroll({
        horizrailenabled: false
    });
    jQuery("#flighthotel2").niceScroll({
        horizrailenabled: false
    });
    jQuery("#cruise2").niceScroll({
        horizrailenabled: false
    });
    jQuery("#hotelcar2").niceScroll({
        horizrailenabled: false
    });
    jQuery("#flighthotelcar2").niceScroll({
        horizrailenabled: false
    });
    ...
    jQuery(window).scroll(function () {
        ...
        if (jQueryiw < 992) {
            ...
            jQuery('.navbar-wrapper2').css({
                'min-height': 100 - (jQueryscrollTop / 2) + 'px'
            });
        }
        jQuery('#dajy').css({
