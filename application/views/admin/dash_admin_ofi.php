        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-user-md"></i>Perfil oficina</li>
            </ol>
          </div>
        </div>
        <!-- page start-->
              ...
              <div class="panel-body">
                <div class="tab-content">
                  ...
                  <div id="edit-profile" class="tab-pane  active">
                    <section class="panel">
                      <div class="panel-body bio-graph-info">
                        <h1> Información de oficina </h1>

                        <form class="form-horizontal" role="form">
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Nombre</label>
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="nm" value="<?=$ofi->nombre;?>" placeholder=" ">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="ubi" placeholder=" " value="<?=$ofi->ubicacion;?>" disabled>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="lat" placeholder=" " value="<?=$ofi->latitud;?>" disabled>
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Longitud</label>
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="long" placeholder=" " value="<?=$ofi->longitud;?>" disabled>
                            </div>
                          </div>
