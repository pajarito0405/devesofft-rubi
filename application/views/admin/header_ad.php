...
<?php if(!$_SESSION['id_admin'] && $_SESSION['role_id'] != '2'  ){
...
<script src="<?=base_url();?>assets_admin/assets/bootstrap-sweetalert-master/dist/sweetalert.js"></script>
    <link rel="stylesheet" href="<?=base_url();?>assets_admin/assets/bootstrap-sweetalert-master/dist/sweetalert.css">
    <!--.......................-->
        ...
        <ul class="nav pull-right top-menu">
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="username"><?=$coop->nombre;?></span>
                            <b class="caret"></b>
                        </a>
