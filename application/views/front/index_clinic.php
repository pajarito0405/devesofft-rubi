...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <!-- Vendor Styles -->
        <link href="<?= base_url();?>assets_front/assets/css/clinic/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
        <link href="<?= base_url();?>assets_front/assets/css/clinic/css/animate.css" rel="stylesheet" type="text/css"/>
        <link href="<?= base_url();?>assets_front/assets/css/clinic/vendor/themify/themify.css" rel="stylesheet" type="text/css"/>
        <link href="<?= base_url();?>assets_front/assets/css/clinic/vendor/scrollbar/scrollbar.min.css" rel="stylesheet" type="text/css"/>
        <link href="<?= base_url();?>assets_front/assets/css/clinic/vendor/swiper/swiper.min.css" rel="stylesheet" type="text/css"/>

        <!-- Theme Styles -->
        <link href="<?= base_url();?>assets_front/assets/css/clinic/css/style.css" rel="stylesheet" type="text/css"/>
        <link href="<?= base_url();?>assets_front/assets/css/clinic/css/global/global.css" rel="stylesheet" type="text/css"/>

        <!-- Favicon -->
        <link rel="shortcut icon" href="img/favicon.ico" type="image/x-icon">
        <link rel="apple-touch-icon" href="<?= base_url();?>assets_front/assets/css/clinic/img/apple-touch-icon.png">
    </head>
    <!-- End Head -->
    ...
    <body>
                        ...
                        <div class="s-header-v2__navbar-col s-header-v2__navbar-col-width--180">
                            ...
                            <div class="s-header-v2__logo">
                                <a href="index.html" class="s-header-v2__logo-link">
                                    <img class="s-header-v2__logo-img s-header-v2__logo-img--default" src="<?= base_url();?>assets_front/assets/css/clinic/img/logo-white.png" alt="Dublin Logo">
                                    <img class="s-header-v2__logo-img s-header-v2__logo-img--shrink" src="<?= base_url();?>assets_front/assets/css/clinic/img/logo.png" alt="Dublin Logo">
                                </a>
                            </div>
                            <!-- End Logo -->
                        </div>
        ...
        <!-- Vendor -->
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/vendor/jquery.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/vendor/jquery.migrate.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/vendor/bootstrap/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/vendor/jquery.smooth-scroll.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/vendor/jquery.back-to-top.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/vendor/scrollbar/jquery.scrollbar.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/vendor/swiper/swiper.jquery.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/vendor/masonry/jquery.masonry.pkgd.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/vendor/masonry/imagesloaded.pkgd.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/vendor/jquery.equal-height.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/vendor/jquery.parallax.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/vendor/jquery.wow.min.js"></script>

        <!-- General Components and Settings -->
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/js/global.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/js/components/header-sticky.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/js/components/scrollbar.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/js/components/swiper.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/js/components/masonry.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/js/components/equal-height.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/js/components/parallax.min.js"></script>
        <script type="text/javascript" src="<?= base_url();?>assets_front/assets/css/clinic/js/components/wow.min.js"></script>
        <!--========== END JAVASCRIPTS ==========-->
