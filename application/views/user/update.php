                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" enctype=multipart/form-data class="form-horizontal"
                              action="<?= site_url('user/update'); ?>" method="post">
                                    ...
                                    <div>
                                        <div class="input-group">
                                            ...
                                            <input type="text" placeholder="<?= translate("nombre_lang"); ?>"
                                                   class="form-control" value="<?= $user_object->name;?>" name="nombre" required="">
                                        </div>
                                    </div>
                                    <br />
                                    ...
                                    <div>
                                        <div class="input-group">
                                            ...
                                            <input type="text" placeholder="<?= translate("cedula_lang"); ?>"
                                                   class="form-control" value="<?= $user_object->cedula;?>" name="cedula" required="">
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div>
                                        <div class="input-group">
                                            ...
                                            <select name="role" class="form-control">
                                                ...
                                                <option <?php if($user_object->role_id == 1){ ?> selected <?php } ?>
                                                    value="1"><?= translate('administrador_lang'); ?></option>
                                                <option <?php if($user_object->role_id == 2){ ?> selected <?php } ?> value="2"><?= translate('docente_lang');?></option>
                                    ...
                                    <div>
                                        <div class="input-group">
                                            ...
                                            <input type="tel" placeholder="<?= translate("phone_lang"); ?>"
                                                   class="form-control" value="<?= $user_object->phone;?>" name="phone" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <textarea class="form-control textarea" name="direccion">
                                            <?php echo $user_object->direccion; ?>
                                        </textarea>
                                    </div>
